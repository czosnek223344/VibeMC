...
public class Main {
    ...
    private static void applyTheme() {
        ...
        Color bg     = new Color(0x1A1714);
        Color panel  = new Color(0x222019);
        Color panel2 = new Color(0x2C2926);
        Color orange = new Color(0xD4845A);
        Color text   = new Color(0xEDE8E3);
        Color dim    = new Color(0x8A8480);
        Color border = new Color(0x38342F);
        Color input  = new Color(0x16140F);
        ...
        UIManager.put("Button.hoverBackground",          new Color(0x35302C));
        UIManager.put("Button.pressedBackground",        new Color(0xD4845A));
        ...
        UIManager.put("List.selectionBackground",        new Color(0x3A2518));
        ...
        UIManager.put("ScrollBar.thumb",                 new Color(0x3D3834));
        UIManager.put("ScrollBar.thumbHover",            new Color(0x4D4844));
        ...
        UIManager.put("Slider.trackColor",               new Color(0x3D3834));
        UIManager.put("ProgressBar.background",          new Color(0x1E1C18));
        ...
        UIManager.put("MenuItem.selectionBackground",    new Color(0x3A2518));
        UIManager.put("MenuItem.selectionForeground",    orange);
        UIManager.put("Separator.foreground",            border);
        UIManager.put("ComboBox.background",             input);
        UIManager.put("ComboBox.foreground",             text);
        UIManager.put("ComboBox.selectionBackground",    new Color(0x3A2518));
        ...
        UIManager.put("Table.selectionBackground",       new Color(0x3A2518));
